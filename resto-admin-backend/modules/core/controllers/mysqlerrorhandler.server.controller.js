...
exports.handleMysqlQueryErrors = function (queryErrOb) {
    ...
    }  else if(queryErrOb.code == 'ER_TRUNCATED_WRONG_VALUE' ||  queryErrOb.errno == '1292') {

        var errMsg = i18next.t("mysql:ER_TRUNCATED_WRONG_VALUE");

        return {
            message: errMsg,
            originalMessage: queryErrOb.sqlMessage,
            httpStatusCode: HTTP_STATUS_CODES.BAD_REQUEST,
            customErrCode: CUSTOM_ERROR_CODES.ER_TRUNCATED_WRONG_VALUE
        };
    }
